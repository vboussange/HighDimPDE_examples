...
in approximating a gaussian function

* Version 2
we fix x over the number of iterations
=#
cd(@__DIR__)
...
nn = Flux.Chain(Dense(d, hls, tanh),
                ...
                # Dense(hls, hls, tanh),
                # Dense(hls, hls, tanh),
                Dense(hls, 1, x -> x^2)) |> gpu # Neural network
...
maxiters = 10000
batch_size = 1000
optimizers = [ADAM(0.001), ADAM(0.0001), ADAM(0.00001)]
